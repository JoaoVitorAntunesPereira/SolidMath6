...
const d3_viewer_1 = document.querySelector("#idD3_viewer_3");
var rangeInp_1 = document.querySelector("#idRange_3");
...
var lb_2 = document.querySelector("#idLabel_3");
...
const octa_geometry_1 = new THREE.OctahedronGeometry(r1, 0); 
...
function animate() {
    ...
    octa_lines_1.geometry = new THREE.OctahedronGeometry(r1);
